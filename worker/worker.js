...
function buildSystemPrompt() {
  ...
  return [
    ...
    'B. Перед тем как поставить source="Оценка ИИ", ты ОБЯЗАН выполнить поиск',
    ...
    'D. source="Оценка ИИ" допустим ТОЛЬКО как абсолютный последний шанс, когда',
    ...
    '3) Только как fallback — собственная оценка с source="Оценка ИИ".',
    '',
    'source = ТОЛЬКО название книги ("Скурихин" / "База преподавателя" / "Оценка ИИ").',
